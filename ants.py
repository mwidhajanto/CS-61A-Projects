...
class Bee(Insect):
    ...
    def action(self, colony):
       ...
       #elif self.armor > 0 and destination is None:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while start_place != beehive: 
            if start_place.bees:
                if places_away >= self.min_range and places_away <= self.max_range:
                    return random_or_none(start_place.bees)
            places_away += 1
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        self.armor < amount
        if self.armor <= 0:
            for bee in starting_place.bees[:]:
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        ...
        for one_bee in bee:
            one_bee.armor = 0
            self.place.remove_insect(one_bee)
        self.digesting = self.digestion_time
        # END Problem 6
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.real_queen:
            ...
            back_of_queen = self.place.exit
            while back_of_queen:
                if back_of_queen.ant:
                    if back_of_queen.ant not in self.doubled_ants:
                        back_of_queen.ant.damage = 2 * back_of_queen.ant.damage 
                        self.doubled_ants.append(back_of_queen.ant)
                    if back_of_queen.ant.is_container and back_of_queen.ant.contained_ant != None and back_of_queen.ant.contained_ant not in self.doubled_ants:
                        back_of_queen.ant.contained_ant.damage = 2 * back_of_queen.ant.contained_ant.damage
                        self.doubled_ants.append(back_of_queen.ant.contained_ant)
                back_of_queen = back_of_queen.exit
        else:
